...
//   "CR - FN", "CR - I", "CR - N", "CR - NF", "CR - SMA",
//   "FN - CR", "FN - FNG", "FN - I", "FN - N", "FN - NX",
//   "FNG - FN", "I - CR", "I - FN", "I - N", 
//   "N - CR", "N - FN", "N - I", "N - NF", "N - SMA",
//   "NF - CR", "NF - FNG", "NF - N", "SMA - CR", "SMA - N", "SMA - SMX",
//   "FN - GLASS", "NF - GLASS", "I - GLASS", "N - GLASS", "CR - GLASS"
// ];
...
//   formula?: string;
//   smiles: string;
//   [key: string]: string | undefined; // to allow dynamic form fields
// };
...
//       const data = await res.json();
//       if (Array.isArray(data)) {
//         setCompounds(data); // ✅ Refill full list
//       } else {
//         console.warn("Unexpected response while resetting:", data);
//         setCompounds([]);
//       }
//     } catch (err) {
...
//               const updated = await fetch("http://localhost:5000/compounds").then((res) => res.json());
//               setCompounds(updated);
//               setSelectedCompound(updatedCompound); // reflect updated details
//             } catch (err) {
...
//           console.log("Submitting compound:", newCompound); // ✅ check this
//           try {
