...
#     valid_phases = {"CR", "N", "I", "FN", "NF", "SMA", "SMX", "FNG", "NX", "GLASS", "DECOMP", "SMZA"}
...
#         # Now handle chains: PHASE - TEMP - PHASE - TEMP - PHASE ...
#         i = 0
...
#                 i += 2  # move forward to next PHASE
#             else:
#                 i += 1
...
#     csv_path = "phase_map_edit_v2.csv"  # ✅ this points to your actual CSV
